function editHomeSliderViewModel() {
    ...
    self.signout = () => {
      ...
      self.editHomeSlider = () => {
          if(!self.text_a1() || !self.text_a2() ||!self.text_a3() ||
          !self.text_b1() ||!self.text_b2() ||!self.text_b3() ||
          !self.text_c1() ||!self.text_c2() ||!self.text_c3() ){
            Swal.fire({
                title: 'Error!',
    ...
    function refreshCurrentUser() {
        $.post(self.host() + '/api/refreshCurrentUser',{token: localStorage.getItem('loginToken')},
         function(data) {
            console.log(data)
