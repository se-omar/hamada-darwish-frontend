function cartViewModel() {
    ...
    self.placeOrder = () => {
        if (self.cartProducts().length < 1) {
            ...
            $.post(
                "http://localhost:3000/api/placeCashOrder",
                {
                ...
                function (data) {
                    ...
                    Swal.fire({
                        title: "Order Placed!",
                        text:
                            "Your order was placed successfully, we will contact you in 24 hours.",
                        icon: "success",
    ...
    function generateKashierOrderHash(cartProducts) {
        ...
        $.post(
            "http://localhost:3000/api/generateKashierOrderHash",
